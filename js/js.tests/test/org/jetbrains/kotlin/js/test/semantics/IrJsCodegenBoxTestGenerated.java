...
public class IrJsCodegenBoxTestGenerated extends AbstractIrJsCodegenBoxTest {
    ...
    public static class Objects extends AbstractIrJsCodegenBoxTest {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class CompanionObjectVisibility extends AbstractIrJsCodegenBoxTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest0(this::doTest, TargetBackend.JS_IR, testDataFilePath);
            }

            public void testAllFilesPresentInCompanionObjectVisibility() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/box/objects/companionObjectVisibility"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.JS_IR, true);
            }
